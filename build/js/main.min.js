...
var _scrollToBuy = require("./modules/scroll-to-buy");
require("./modules/price");
var _coaches = require("./modules/coaches");
var _reviews = require("./modules/reviews");
var _initTabs = require("./vendor/init-tabs");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.setPlayClickHandler)();
  (0, _scrollToBuy.setBuySectionButtonHandler)();

  // Modules
  // ---------------------------------

  (0, _coaches.initCoachesSlider)();
  (0, _reviews.initReviewsSlider)();
...
},{"./modules/coaches":2,"./modules/form-validate/form":4,"./modules/price":10,"./modules/reviews":11,"./modules/scroll-to-buy":12,"./modules/video":13,"./utils/ios-vh-fix":15,"./vendor/init-accordion":17,"./vendor/init-tabs":18}],2:[function(require,module,exports){
"use strict";
...
exports.initCoachesSlider = void 0;
...
var infoCoaches = document.querySelectorAll('.coach__info');
var initCoachesSlider = function initCoachesSlider() {
  // createSlider('.coaches__slider', true, 4, 2, 1);

  _swiper.default.use([_swiper.Navigation]);
  var swiper = new _swiper.default('.coaches__slider', {
    // Optional parameters
...
exports.initCoachesSlider = initCoachesSlider;
var _iterator = _createForOfIteratorHelper(infoCoaches),
  _step;
try {
  var _loop = function _loop() {
    var infoCoach = _step.value;
    infoCoach.addEventListener('click', function (evt) {
      evt.preventDefault();
      infoCoach.focus();
    });
  };
...
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var priceWraps = document.querySelectorAll('.subscription-card__price-wrap');
var _iterator = _createForOfIteratorHelper(priceWraps),
  _step;
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var priceWrap = _step.value;
    var price = priceWrap.querySelector('.subscription-card__price');
...
var initReviewsSlider = function initReviewsSlider() {
  ...
  _swiper.default.use([_swiper.Navigation]);
  var swiper = new _swiper.default('.reviews__slider', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    // Navigation arrows
...
},{"../vendor/swiper":19}],12:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setBuySectionButtonHandler = void 0;
var buySection = document.querySelector('.buy');
var button = document.querySelector('.main-header__btn');
var scrollToBuy = function scrollToBuy() {
  buySection.scrollIntoView();
};
var setBuySectionButtonHandler = function setBuySectionButtonHandler() {
  button.addEventListener('click', scrollToBuy);
};
exports.setBuySectionButtonHandler = setBuySectionButtonHandler;
...
exports.setPlayClickHandler = void 0;
var video = document.querySelector('.video');
var buttonPlay = document.querySelector('.video__button');
...
var setPlayClickHandler = function setPlayClickHandler() {
  buttonPlay.addEventListener('click', createFrame);
};
exports.setPlayClickHandler = setPlayClickHandler;
...
},{"./accordions":16}],18:[function(require,module,exports){
"use strict";
...
},{"./tabs":20}],19:[function(require,module,exports){
